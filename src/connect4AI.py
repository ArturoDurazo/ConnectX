...
def winning_move(board, piece):
    ...
    for c in range(COLUMN_COUNT - 3):  # because theres no 4 in the last 3
        for r in range(ROW_COUNT):
...
def evaluate_window(window, piece):
    ...
    #irrelevant unless depth = 0 because now it can look into the future
...
def score_position(board, piece):
    ...
    for r in range(ROW_COUNT):
        ...
        for c in range(COLUMN_COUNT - 3):
            #count in windows of 4 but skip the last 3
